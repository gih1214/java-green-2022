...
// 1. new 할 수 없다.
// 2. 추상 메서드를 만들 수 있다. (몸체없이 만들 수 있다.)(객체의 행위를 공통적으로 정의할 수 없을 때)
...
public class ExtendsEx04 {
    ...
    static void attack(ProtossUnit u1, ProtossUnit u2) {
        // 1. u1이 u2를 공격 => u2.hp = u2.hp - u1.attack => 자식변수 접근 안 되군 => 오버라이드 하자
    ...
    public static void main(String[] args) {
        ...
        ProtossUnit t2 = new DarkTempler();
        attack(z1, d1);
        attack(t2, z1);
    }
}
