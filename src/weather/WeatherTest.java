...
public class WeatherTest {
    public static void main(String[] args) {
        ...
        try {
            URL url = new URL(
                    "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?serviceKey=0sNm6wu8LtWsmwYOwcbFAAaEM4DGiVJq9P5TxgDHuevY4IQG%2FxPTYzCzgULmdymmWB9A5iEubhq3zjn8BRXAOw%3D%3D&pageNo=1&numOfRows=1000&dataType=JSON&base_date=20220126&base_time=1200&nx=97&ny=75");
